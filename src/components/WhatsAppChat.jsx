...
const WhatsAppChat = () => {
  ...
  return (
    <>
      ...
      <button
        onClick={toggleChat}
        className={`whatsapp-toggle-btn fixed bottom-6 right-6 z-50 text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-500 transform hover:scale-110 ${
          !isOpen 
